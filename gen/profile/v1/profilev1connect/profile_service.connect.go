...
const (
	...
	// ListProfiles RPC.
	ProfileServiceListProfilesProcedure = "/profile.v1.ProfileService/ListProfiles"
	...
	// CreateProfile RPC.
	ProfileServiceCreateProfileProcedure = "/profile.v1.ProfileService/CreateProfile"
...
// CreateProfile calls profile.v1.ProfileService.CreateProfile.
...
// DeleteProfile calls profile.v1.ProfileService.DeleteProfile.
...
func (UnimplementedProfileServiceHandler) ListProfiles(context.Context, *connect.Request[v1.ListProfilesRequest]) (*connect.Response[v1.ListProfilesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("profile.v1.ProfileService.ListProfiles is not implemented"))
}
...
func (UnimplementedProfileServiceHandler) CreateProfile(context.Context, *connect.Request[v1.CreateProfileRequest]) (*connect.Response[v1.CreateProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("profile.v1.ProfileService.CreateProfile is not implemented"))
}
