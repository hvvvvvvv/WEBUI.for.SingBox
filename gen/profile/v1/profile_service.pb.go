...
var (
	...
	file_profile_v1_profile_service_proto_rawDescData []byte
)

func file_profile_v1_profile_service_proto_rawDescGZIP() []byte {
	file_profile_v1_profile_service_proto_rawDescOnce.Do(func() {
		file_profile_v1_profile_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_profile_v1_profile_service_proto_rawDesc), len(file_profile_v1_profile_service_proto_rawDesc)))
	})
