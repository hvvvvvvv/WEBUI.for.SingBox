...
const protoFieldNames: Record<string, string> = {
  ...
  iproute2_table_index: 'iproute2TableIndex',
  iproute2_rule_index: 'iproute2RuleIndex',
    ...
    return {
      ...
      tun: tun
        ? {
            ...
            iproute2_table_index: tun.iproute2_table_index ?? tun.iproute2tableindex ?? undefined,
            iproute2_rule_index: tun.iproute2_rule_index ?? tun.iproute2ruleindex ?? undefined,
