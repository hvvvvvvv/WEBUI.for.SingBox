  ...
  kernel: {
    ...
    route: {
      ...
      rules: {
        ...
        executeAction: '执行动作',
        changeAction: '更换动作',
        rawOverrideHint: 'Raw JSON 中的同名字段会覆盖结构化匹配和动作字段',
        actionDescription: {
          route: '将连接发送到指定出站。',
        ...
        fields: {
          ip_version: 'IP 版本',
          preferred_by: '首选路由 (preferred_by)',
          source_ip_cidr: '源 IP CIDR',
          source_ip_is_private: '源 IP 为私有地址',
          source_port: '源端口',
          ...
          udp_connect: '连接 UDP 目标',
          udp_timeout: 'UDP 超时',
          tls_fragment: 'TLS 分片',
          tls_fragment_fallback_delay: 'TLS 分片回退延迟',
          tls_record_fragment: 'TLS 记录分片',
          tls_spoof: 'TLS 欺骗 SNI',
          tls_spoof_method: 'TLS 欺骗方式',
          no_drop: '禁用自动丢弃',
          timeout: '超时',
        ...
        notFound: '出站标签缺失。',
        invalid: '无效参数',
        inlineInvalidPayload: 'Inline 荷载必须是合法 JSON 对象',
        inlineActionRequired: 'Inline 荷载必须定义非空 action 字段',
        inlineGroupRequired: 'Inline 动作必须添加内联扩展组并填写 raw',
        routeOutboundRequired: 'Route 动作必须选择出站',
