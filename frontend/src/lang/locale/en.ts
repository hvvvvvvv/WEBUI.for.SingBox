  ...
  profiles: {
    ...
    qrs: {
      ...
      rulesetError: {
        ...
        formatMismatch: 'The configuration and rule-set resource formats do not match.',
        binaryNotHttp: 'The binary rule-set resource is not an HTTP resource.',
        binaryUrlEmpty: 'The binary rule-set resource URL is empty.',
        sourceLoadFailed: 'Failed to read the rule-set source: {detail}',
        sourceInvalidJson: 'The rule-set source is not valid JSON: {detail}',
        sourceRulesMissing: 'The rule-set source is missing the rules field.',
        sourceRulesInvalid: 'The rule-set rules must be an array or rule object.',
        unsupportedFormat: 'The local rule-set format is not supported.',
        localRemaining: 'A local rule set remains after conversion.',
      },
    },
  },
  ruleset: {
