  ...
  kernel: {
    ...
    route: {
      ...
      rules: {
        ...
        rawOverrideHint:
          'Fields in Raw JSON override matching structured match and action fields',
        actionDescription: {
        ...
        fields: {
          ...
          preferred_by: 'Preferred Route (preferred_by)',
          source_ip_cidr: 'Source IP CIDR',
          source_ip_is_private: 'Source IP Is Private',
          ...
          ip_is_private: 'Destination IP Is Private',
          ...
          tls_spoof: 'TLS Spoof SNI',
          tls_spoof_method: 'TLS Spoof Method',
          no_drop: 'No Drop',
          timeout: 'Timeout',
          disable_optimistic_cache: 'Disable Optimistic DNS Cache',
          rewrite_ttl: 'Rewrite TTL',
        },
        notFound: 'Outbound tag is missing.',
        invalid: 'Invalid Parameter',
        inlineInvalidPayload: 'Inline payload must be a valid JSON object',
        inlineActionRequired: 'Inline payload must define a non-empty action field',
